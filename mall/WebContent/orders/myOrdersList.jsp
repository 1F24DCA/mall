...
<html>
	...
	<%
		...
		paramOrders.setMemberEmail(member.getMemberEmail());
		
		OrdersDao ordersDao = new OrdersDao();
		ArrayList<OrdersAndProduct> list = ordersDao.selectOrdersListWithPageDescSearchByMemberEmail(listPage, paramOrders);
	%>
	...
	<body>
		...
		<div class="container-lg mt-4 mb-5">
			<div class="container-lg mt-4 mb-5">
				<h2 class="font-weight-bolder">내 주문목록</h2>
				
				<hr>
				
				<h6 class="font-weight-lighter">주문목록은 최근 20건까지만 노출됩니다</h6>
				
				<%
					for (OrdersAndProduct oap : list) {
				%>
						<div class="row d-flex align-items-center p-1">
							<div class="col-1"><img class="img-fluid border" src="http://<%=request.getServerName()%>/mall-admin/image/<%=oap.getProduct().getProductPic()%>"></div>
							<div class="col-11">
								<div class="d-flex justify-content-between">
									...
									<div>
										<h5 class="font-weight-bolder"><%=oap.getOrders().getOrdersState() %></h5>
									</div>
								</div>
							</div>
						</div>
