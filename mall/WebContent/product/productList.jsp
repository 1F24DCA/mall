			...
			<form method="post" action="<%=request.getContextPath()%>/product/productList.jsp">
				...
				<div class="row">
					...
					<div class="col d-flex align-items-center">
						<input class="form-control" type="text" name="searchProductName" value="<%=searchProductName%>" placeholder="이름으로 상품 검색">
					</div>
								...
								%>
										<div class="col-4">
											<a class="card mb-4 p-3 bg-light border-0 text-reset text-decoration-none" href="<%=request.getContextPath()%>/product/productOne.jsp?productId=<%=pac.getProduct().getProductId()%>">
												<img class="card-img-top border" src="http://<%=request.getServerName()%>:<%=request.getServerPort()%>/mall-admin/image/<%=pac.getProduct().getProductPic()%>" alt="Card image">
												<div class="card-body">
